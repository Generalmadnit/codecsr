public class UseRectangle{
    public static void main(String []ar){
        ...
        Rectangle r2 = new Rectangle(1.5,6.3);
        Rectangle.sayHello();
        // r1.setDim(1.5, 6.30);
        // r2.setDim(1.9,6.1);
        ...
        System.out.println("The length is "+r1.getLen()+" and breadth is "+r1.getBre());
        System.out.println("Area of r1 is :      "+a1);
        System.out.println("Perimeter of r1 is : "+p1);
        System.out.println(""+r1);
        System.out.println("The length is "+r2.getLen()+" and breadth is "+r2.getBre());
